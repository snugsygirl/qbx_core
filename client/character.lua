...
local function cinematicSpawn(coords)
    ...
    -- Sync scene creation using target coords
    -- Note: The original snippet used pos.z-1.0 for vec4 but SetEntityCoords used coords.z
    -- We'll assume the passed coords are ground coords? 
    -- If passed coords are from QBX.PlayerData.position, they might be correct.
    -- Original snippet: local coords = vec4(pos.x, pos.y, pos.z-1.0, heading)
    -- This suggests the animation root is slightly below the ped?
